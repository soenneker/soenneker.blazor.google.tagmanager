namespace Soenneker.Blazor.Google.TagManager.Models;

/// <summary>
/// Consent Mode V2 settings for Google Tag Manager.
/// </summary>
public sealed class GoogleTagManagerConsentSettings
{
    /// <summary>
    ...
    /// <summary>
    /// Optional time for tags to wait for a consent update. Applies only to default consent.
    /// </summary>
